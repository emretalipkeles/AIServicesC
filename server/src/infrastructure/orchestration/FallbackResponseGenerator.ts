...
const FALLBACK_SYSTEM_PROMPT = `You are AI Assistant for Construction Delay Analyzer, a specialized platform for interpreting contractor-caused delays in construction projects.
